...
-- Date        : Fri Oct 31 14:04:04 2025
-- Host        : TheJackdaw running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               d:/Xillinx_Project/PROJECT/lz4_cmpress/lz4CompressEngineRun/hls/impl/verilog/project.gen/sources_1/bd/bd_0/ip/bd_0_hls_inst_0/bd_0_hls_inst_0_stub.vhdl
...
entity bd_0_hls_inst_0 is
  Port ( 
    ...
    max_lit_limit_ce1 : out STD_LOGIC;
    max_lit_limit_we1 : out STD_LOGIC;
    ...
    max_lit_limit_q0 : in STD_LOGIC_VECTOR ( 31 downto 0 );
    max_lit_limit_address1 : out STD_LOGIC_VECTOR ( 2 downto 0 );
    max_lit_limit_d1 : out STD_LOGIC_VECTOR ( 31 downto 0 );
    max_lit_limit_q1 : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute CORE_GENERATION_INFO of bd_0_hls_inst_0 : entity is "bd_0_hls_inst_0,lz4CompressEngineRun,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=lz4CompressEngineRun,x_ipVersion=1.0,x_ipCoreRevision=2114327762,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
...
architecture stub of bd_0_hls_inst_0 is
  ...
  attribute X_INTERFACE_INFO of max_lit_limit_address0 : signal is "xilinx.com:signal:data:1.0 max_lit_limit_address0 DATA";
  attribute X_INTERFACE_MODE of max_lit_limit_address0 : signal is "master";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of max_lit_limit_address0 : signal is "XIL_INTERFACENAME max_lit_limit_address0, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of max_lit_limit_d0 : signal is "xilinx.com:signal:data:1.0 max_lit_limit_d0 DATA";
  attribute X_INTERFACE_MODE of max_lit_limit_d0 : signal is "master";
  attribute X_INTERFACE_PARAMETER of max_lit_limit_d0 : signal is "XIL_INTERFACENAME max_lit_limit_d0, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of max_lit_limit_q0 : signal is "xilinx.com:signal:data:1.0 max_lit_limit_q0 DATA";
  attribute X_INTERFACE_MODE of max_lit_limit_q0 : signal is "slave";
  attribute X_INTERFACE_PARAMETER of max_lit_limit_q0 : signal is "XIL_INTERFACENAME max_lit_limit_q0, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of max_lit_limit_address1 : signal is "xilinx.com:signal:data:1.0 max_lit_limit_address1 DATA";
  attribute X_INTERFACE_MODE of max_lit_limit_address1 : signal is "master";
  attribute X_INTERFACE_PARAMETER of max_lit_limit_address1 : signal is "XIL_INTERFACENAME max_lit_limit_address1, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of max_lit_limit_d1 : signal is "xilinx.com:signal:data:1.0 max_lit_limit_d1 DATA";
  attribute X_INTERFACE_MODE of max_lit_limit_d1 : signal is "master";
  attribute X_INTERFACE_PARAMETER of max_lit_limit_d1 : signal is "XIL_INTERFACENAME max_lit_limit_d1, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of max_lit_limit_q1 : signal is "xilinx.com:signal:data:1.0 max_lit_limit_q1 DATA";
  attribute X_INTERFACE_MODE of max_lit_limit_q1 : signal is "slave";
  attribute X_INTERFACE_PARAMETER of max_lit_limit_q1 : signal is "XIL_INTERFACENAME max_lit_limit_q1, LAYERED_METADATA undef";
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_RESET ap_rst, FREQ_HZ 142000000.0, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_0_ap_clk_0, INSERT_VIP 0";
