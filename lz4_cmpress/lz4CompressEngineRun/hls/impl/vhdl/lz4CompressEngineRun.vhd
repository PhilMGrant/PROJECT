...
architecture behav of lz4CompressEngineRun is 
    ...
    "lz4CompressEngineRun_lz4CompressEngineRun,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=92,HLS_SYN_DSP=0,HLS_SYN_FF=5388,HLS_SYN_LUT=8304,HLS_VERSION=2024_2}";
    ...
    signal entry_proc_U0_core_idx_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc_U0_core_idx_c_write : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_ap_start : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_ap_done : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_ap_continue : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_ap_idle : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_start_out : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_start_write : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_inStream_read : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_compressdStream_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lzCompress_6_4_65536_6_1_1024_64_U0_compressdStream_write : STD_LOGIC;
    signal lzCompress_6_4_65536_6_1_1024_64_U0_compressdStream_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal lzCompress_6_4_65536_6_1_1024_64_U0_compressdStream_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    signal lzCompress_6_4_65536_6_1_1024_64_U0_input_size_c2_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lzCompress_6_4_65536_6_1_1024_64_U0_input_size_c2_write : STD_LOGIC;
    ...
    signal lz4Compress_4096_8_U0_boosterStream_read : STD_LOGIC;
    signal lz4Compress_4096_8_U0_lz4Out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal lz4Compress_4096_8_U0_lz4Out_write : STD_LOGIC;
    signal lz4Compress_4096_8_U0_max_lit_limit_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal lz4Compress_4096_8_U0_max_lit_limit_ce0 : STD_LOGIC;
    signal lz4Compress_4096_8_U0_max_lit_limit_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal lz4Compress_4096_8_U0_max_lit_limit_we0 : STD_LOGIC;
    signal lz4Compress_4096_8_U0_max_lit_limit_address1 : STD_LOGIC_VECTOR (2 downto 0);
    signal lz4Compress_4096_8_U0_max_lit_limit_ce1 : STD_LOGIC;
    signal lz4Compress_4096_8_U0_max_lit_limit_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal lz4Compress_4096_8_U0_max_lit_limit_we1 : STD_LOGIC;
    signal lz4Compress_4096_8_U0_input_size_read : STD_LOGIC;
    signal lz4Compress_4096_8_U0_lz4Out_eos_din : STD_LOGIC_VECTOR (0 downto 0);
    signal lz4Compress_4096_8_U0_lz4Out_eos_write : STD_LOGIC;
    signal lz4Compress_4096_8_U0_lz4OutSize_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lz4Compress_4096_8_U0_lz4OutSize_write : STD_LOGIC;
    signal lz4Compress_4096_8_U0_index_read : STD_LOGIC;
    signal lz4Compress_4096_8_U0_ap_start : STD_LOGIC;
    signal lz4Compress_4096_8_U0_ap_done : STD_LOGIC;
    signal lz4Compress_4096_8_U0_ap_ready : STD_LOGIC;
    signal lz4Compress_4096_8_U0_ap_idle : STD_LOGIC;
    signal lz4Compress_4096_8_U0_ap_continue : STD_LOGIC;
    signal core_idx_c_full_n : STD_LOGIC;
    signal core_idx_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal core_idx_c_empty_n : STD_LOGIC;
    signal core_idx_c_num_data_valid : STD_LOGIC_VECTOR (3 downto 0);
    signal core_idx_c_fifo_cap : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal ap_sync_reg_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready : STD_LOGIC;
    signal start_for_lz4Compress_4096_8_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_lz4Compress_4096_8_U0_full_n : STD_LOGIC;
    signal start_for_lz4Compress_4096_8_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_lz4Compress_4096_8_U0_empty_n : STD_LOGIC;
    ...
    component lz4CompressEngineRun_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        core_idx : IN STD_LOGIC_VECTOR (31 downto 0);
        core_idx_c_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        core_idx_c_full_n : IN STD_LOGIC;
        core_idx_c_write : OUT STD_LOGIC;
        core_idx_c_num_data_valid : IN STD_LOGIC_VECTOR (3 downto 0);
        core_idx_c_fifo_cap : IN STD_LOGIC_VECTOR (3 downto 0) );
    end component;


    component lz4CompressEngineRun_lzCompress_6_4_65536_6_1_1024_64_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component lz4CompressEngineRun_lz4Compress_4096_8_s IS
    port (
    ...
    component lz4CompressEngineRun_fifo_w32_d5_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component lz4CompressEngineRun_start_for_lz4Compress_4096_8_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component lz4CompressEngineRun_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    lzCompress_6_4_65536_6_1_1024_64_U0 : component lz4CompressEngineRun_lzCompress_6_4_65536_6_1_1024_64_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    lz4Compress_4096_8_U0 : component lz4CompressEngineRun_lz4Compress_4096_8_s
    port map (
        ...
        max_lit_limit_q0 => ap_const_lv32_0,
        ...
        max_lit_limit_q1 => ap_const_lv32_0,
    ...
    core_idx_c_U : component lz4CompressEngineRun_fifo_w32_d5_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    start_for_lz4Compress_4096_8_U0_U : component lz4CompressEngineRun_start_for_lz4Compress_4096_8_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    ap_done <= lz4Compress_4096_8_U0_ap_done;
    ap_idle <= (lzCompress_6_4_65536_6_1_1024_64_U0_ap_idle and lzBooster_255_16384_64_U0_ap_idle and lzBestMatchFilter_6_65536_U0_ap_idle and lz4Compress_4096_8_U0_ap_idle and entry_proc_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_entry_proc_U0_ap_ready <= (entry_proc_U0_ap_ready or ap_sync_reg_entry_proc_U0_ap_ready);
    ap_sync_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready <= (lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready or ap_sync_reg_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready);
    ap_sync_ready <= (ap_sync_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready and ap_sync_entry_proc_U0_ap_ready);
    entry_proc_U0_ap_continue <= ap_const_logic_1;
    entry_proc_U0_ap_start <= ((ap_sync_reg_entry_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    inStream_read <= lzCompress_6_4_65536_6_1_1024_64_U0_inStream_read;
    lz4Compress_4096_8_U0_ap_continue <= ap_const_logic_1;
    lz4Compress_4096_8_U0_ap_start <= start_for_lz4Compress_4096_8_U0_empty_n;
    lz4OutSize_din <= lz4Compress_4096_8_U0_lz4OutSize_din;
    lz4OutSize_write <= lz4Compress_4096_8_U0_lz4OutSize_write;
    lz4Out_din <= lz4Compress_4096_8_U0_lz4Out_din;
    lz4Out_eos_din <= lz4Compress_4096_8_U0_lz4Out_eos_din;
    ...
    lzCompress_6_4_65536_6_1_1024_64_U0_ap_continue <= ap_const_logic_1;
    lzCompress_6_4_65536_6_1_1024_64_U0_ap_start <= ((ap_sync_reg_lzCompress_6_4_65536_6_1_1024_64_U0_ap_ready xor ap_const_logic_1) and ap_start);
    lzCompress_6_4_65536_6_1_1024_64_U0_compressdStream_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(compressdStream_fifo_cap),4))),32));
    lzCompress_6_4_65536_6_1_1024_64_U0_compressdStream_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(compressdStream_num_data_valid),4))),32));
    max_lit_limit_address0 <= lz4Compress_4096_8_U0_max_lit_limit_address0;
    max_lit_limit_address1 <= ap_const_lv3_0;
    max_lit_limit_ce0 <= lz4Compress_4096_8_U0_max_lit_limit_ce0;
    max_lit_limit_ce1 <= ap_const_logic_0;
    max_lit_limit_d0 <= lz4Compress_4096_8_U0_max_lit_limit_d0;
    max_lit_limit_d1 <= ap_const_lv32_0;
    max_lit_limit_we0 <= lz4Compress_4096_8_U0_max_lit_limit_we0;
    max_lit_limit_we1 <= ap_const_logic_0;
    start_for_lz4Compress_4096_8_U0_din <= (0=>ap_const_logic_1, others=>'-');
