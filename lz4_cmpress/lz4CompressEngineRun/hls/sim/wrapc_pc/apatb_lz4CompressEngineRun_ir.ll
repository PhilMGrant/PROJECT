; ModuleID = 'D:/Xillinx_Project/PROJECT/lz4_cmpress/lz4CompressEngineRun/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %0 = bitcast i32* %max_lit_limit to [8 x i32]*
  %max_lit_limit_copy = alloca [8 x i32], align 512
  call fastcc void @copy_in(%"class.hls::stream<ap_uint<8>, 0>"* nonnull %inStream, i8* nonnull align 512 %inStream_copy, %"class.hls::stream<ap_uint<8>, 0>"* nonnull %lz4Out, i8* nonnull align 512 %lz4Out_copy, %"class.hls::stream<bool, 0>"* nonnull %lz4Out_eos, i1* nonnull align 512 %lz4Out_eos_copy, %"class.hls::stream<unsigned int, 0>"* nonnull %lz4OutSize, i32* nonnull align 512 %lz4OutSize_copy, [8 x i32]* nonnull %0, [8 x i32]* nonnull align 512 %max_lit_limit_copy)
  call void @apatb_lz4CompressEngineRun_hw(i8* %inStream_copy, i8* %lz4Out_copy, i1* %lz4Out_eos_copy, i32* %lz4OutSize_copy, [8 x i32]* %max_lit_limit_copy, i32 %input_size, i32 %core_idx)
  call void @copy_back(%"class.hls::stream<ap_uint<8>, 0>"* %inStream, i8* %inStream_copy, %"class.hls::stream<ap_uint<8>, 0>"* %lz4Out, i8* %lz4Out_copy, %"class.hls::stream<bool, 0>"* %lz4Out_eos, i1* %lz4Out_eos_copy, %"class.hls::stream<unsigned int, 0>"* %lz4OutSize, i32* %lz4OutSize_copy, [8 x i32]* %0, [8 x i32]* %max_lit_limit_copy)
  ret void
}
...
define internal fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* noalias align 512 %dst, [8 x i32]* noalias readonly %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8i32([8 x i32]* %dst, [8 x i32]* readonly %src, i64 %num) local_unnamed_addr #6 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_out(%"class.hls::stream<ap_uint<8>, 0>"* noalias "unpacked"="0", i8* noalias nocapture align 512 "unpacked"="1.0", %"class.hls::stream<ap_uint<8>, 0>"* noalias "unpacked"="2", i8* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<bool, 0>"* noalias "unpacked"="4", i1* noalias nocapture align 512 "unpacked"="5.0", %"class.hls::stream<unsigned int, 0>"* noalias "unpacked"="6", i32* noalias nocapture align 512 "unpacked"="7.0", [8 x i32]* noalias "unpacked"="8", [8 x i32]* noalias readonly align 512 "unpacked"="9") unnamed_addr #7 {
entry:
...
declare void @apatb_lz4CompressEngineRun_hw(i8*, i8*, i1*, i32*, [8 x i32]*, i32, i32)

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @copy_back(%"class.hls::stream<ap_uint<8>, 0>"* noalias "unpacked"="0", i8* noalias nocapture align 512 "unpacked"="1.0", %"class.hls::stream<ap_uint<8>, 0>"* noalias "unpacked"="2", i8* noalias nocapture align 512 "unpacked"="3.0", %"class.hls::stream<bool, 0>"* noalias "unpacked"="4", i1* noalias nocapture align 512 "unpacked"="5.0", %"class.hls::stream<unsigned int, 0>"* noalias "unpacked"="6", i32* noalias nocapture align 512 "unpacked"="7.0", [8 x i32]* noalias "unpacked"="8", [8 x i32]* noalias readonly align 512 "unpacked"="9") unnamed_addr #7 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<8>, 0>"(%"class.hls::stream<ap_uint<8>, 0>"* %0, i8* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<8>, 0>"(%"class.hls::stream<ap_uint<8>, 0>"* %2, i8* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<bool, 0>"(%"class.hls::stream<bool, 0>"* %4, i1* align 512 %5)
...
define void @lz4CompressEngineRun_hw_stub_wrapper(i8*, i8*, i1*, i32*, [8 x i32]*, i32, i32) #8 {
entry:
  ...
  call void @copy_out(%"class.hls::stream<ap_uint<8>, 0>"* %8, i8* %0, %"class.hls::stream<ap_uint<8>, 0>"* %10, i8* %1, %"class.hls::stream<bool, 0>"* %12, i1* %2, %"class.hls::stream<unsigned int, 0>"* %14, i32* %3, [8 x i32]* null, [8 x i32]* %4)
  %15 = bitcast [8 x i32]* %4 to i32*
  ...
  call void @copy_in(%"class.hls::stream<ap_uint<8>, 0>"* %8, i8* %0, %"class.hls::stream<ap_uint<8>, 0>"* %10, i8* %1, %"class.hls::stream<bool, 0>"* %12, i1* %2, %"class.hls::stream<unsigned int, 0>"* %14, i32* %3, [8 x i32]* null, [8 x i32]* %4)
  call void @free(i8* %7)
  call void @free(i8* %9)
