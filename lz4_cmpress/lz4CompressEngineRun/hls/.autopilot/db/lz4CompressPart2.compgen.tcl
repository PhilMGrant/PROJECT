...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { lit_outStream_dout { I 8 vector } lit_outStream_empty_n { I 1 bit } lit_outStream_read { O 1 bit } lit_outStream_num_data_valid { I 17 vector } lit_outStream_fifo_cap { I 17 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { lenOffset_Stream_dout { I 64 vector } lenOffset_Stream_empty_n { I 1 bit } lenOffset_Stream_read { O 1 bit } lenOffset_Stream_num_data_valid { I 10 vector } lenOffset_Stream_fifo_cap { I 10 vector } } \
} "
}
